...
<head>
  ...
  <style>
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .cast-thumb{width:72px;height:72px;object-fit:contain;border-radius:6px;border:1px solid #1e2d4a;flex-shrink:0;background:#16213e}
    ...
    .cast-rm{position:absolute;top:-7px;right:-7px;width:20px;height:20px;border-radius:50%;background:#e94560;border:2px solid #0a0e1a;color:#fff;cursor:pointer;font-size:.65rem;display:flex;align-items:center;justify-content:center;line-height:1;padding:0;transition:.15s}
